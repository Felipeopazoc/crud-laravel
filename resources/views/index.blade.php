                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="w-75 m-auto" action="{{url('update',['id'=>$usuario->id])}}">
                                                <div class="col-12">
                                                    <label for="">Id</label>
                                                    <input disabled class="form-control" type="number" name="id" required value="{{$usuario->id}}">
                                                </div>
                                                <div class="col-12">
                                                    <label for="">Nombre</label>
                                                    <input class="form-control" type="text" name="name" value="{{$usuario->nombre}}">
                                                </div>
                                                <div class="col-12">
                                                ...
                                                <div class="col-12 mb-2">
                                                    ...
                                                    <input class="form-control" type="text" name="edad" value="{{$usuario->edad}}">
                                                </div>
                                                <div class="col-6">
